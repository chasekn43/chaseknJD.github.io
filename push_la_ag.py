...
<body>
  ...
  <div class="doc-grid">
    ...
    <div class="doc-card">
      ...
      <div class="doc-meta">Madison Marshall Email & Aug 6 Pro Se Ethics Notice</div>
...
subprocess.run(['git', 'commit', '-m', 'Add Louisiana Attorney General Executive Submission PDF and update website evidence vault grid'], cwd=repo_dir)
