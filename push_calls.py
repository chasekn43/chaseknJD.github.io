...
<head>
  ...
  <meta name="description" content="Official public case record, police report, CFPB complaint filings, call logs, and primary evidence documents for Affirm, Inc. (NYSE: AFRM) BNPL loan dispute. CFPB Complaint #260717-35668593.">
  <meta name="keywords" content="Affirm, Affirm dispute, Affirm account locked, Affirm loan fraud, Affirm CFPB response, Affirm false chargeback, Buy Now Pay Later dispute, Affirm lawsuit, Morgan Lewis Affirm, UDAAP compliance, police report, call history logs, Louisiana AG dispute, evidence documents, Charles Kinslow">
  ...
  <meta property="og:description" content="Public evidence repository: Police report, CFPB filings, mobile call logs, Louisiana AG submission, liability clearance letters, and Morgan Lewis correspondence in Kinslow v. Affirm, Inc.">
  ...
  <script type="application/ld+json">
  {
    ...
    "description": "Public evidentiary repository containing police reports, call logs, CFPB complaints, Louisiana AG dispute filings, liability clearance letters, and legal directives.",
    "author": {
      "@type": "Person",
...
<body>
  ...
  <div class="doc-grid">
    ...
    <div class="doc-card">
      <div class="doc-title">📞 Mobile Call History Screenshots & Telephonic Log</div>
  ...
  <ul>
    <li><strong>July 7, 2026 (11:53 AM CDT):</strong> Unauthorized fraudulent transaction <code>PE270138</code> ($104.63) originated on Shop Pay / Affirm, shipping perfume to San Jose, CA.</li>
    ...
    <li><strong>July 7, 2026 (1:27 PM – 4:12 PM CDT) — The Loading Dock Window:</strong> Shipping label created in Farmers Branch, TX (75234) at 1:27 PM, but package did not receive carrier origin scan in DeSoto, TX (75115) until 4:12 PM — giving Affirm and merchant 2 hours 45 minutes to pull box off dock.</li>
    <li><strong>July 9, 2026 (11:47 AM CDT):</strong> Affirm Customer Care (Agent "Jason") dispatched formal email promising a 30-day investigation and credit hold.</li>
    <li><strong>July 9, 2026 (12:21 PM & 2:15 PM CDT) — Supplemental Investigation Calls:</strong> Consumer placed two supplemental calls to Affirm Customer Support to provide carrier tracking metrics, police report details, and evidence for the active investigation file.</li>
    <li><strong>July 9, 2026 (1:13 PM CDT — The 86-Minute Sham Denial):</strong> Exactly 86 minutes after Agent "Jason's" email, Affirm's automated credit engine dispatched a final denial closing the investigation without human review of IP logs, device fingerprints, or geographic anomalies.</li>
    <li><strong>July 10, 2026:</strong> Formal identity theft report filed with Monroe Police Department (Case <code>#26-29572</code>).</li>
...
subprocess.run(['git', 'commit', '-m', 'Add Document Card #9 for Mobile Call History Screenshots and weave July 7 & July 9 (12:21 PM and 2:15 PM) customer support calls into master chronology'], cwd=repo_dir)
